package be.vandenn3.quiestce.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof be.vandenn3.quiestce.service.EmailAlreadyUsedException ||
            ex instanceof be.vandenn3.quiestce.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof be.vandenn3.quiestce.service.InvalidPasswordException
