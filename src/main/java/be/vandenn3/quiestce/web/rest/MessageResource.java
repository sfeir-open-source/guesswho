...
/**
 * REST controller for managing {@link be.vandenn3.quiestce.domain.Message}.
 */
@RestController
@RequestMapping("/api")
public class MessageResource {
     ...
     */
    @GetMapping("/messages")
    public List<MessageDTO> getAllMessages(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
